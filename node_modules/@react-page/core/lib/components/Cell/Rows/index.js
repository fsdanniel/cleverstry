...
var Rows = /** @class */ (function (_super) {
    ...
    Rows.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "ory-cell-inner ory-cell-rows" }, rows.map(function (r) { return (React.createElement(Row_1.default, __assign({ editable: editable, ancestors: __spread(ancestors, [id]), id: r, key: r }, rest))); })));
    };
    return Rows;
}(React.PureComponent));
