...
exports.generateMissingIds = function (props) {
    ...
    return __assign(__assign({}, props), { id: id || uuid_1.v4() });
};
/**
...
var PluginService = /** @class */ (function () {
    ...
    function PluginService(_a) {
        ...
        this.setContentPlugins = function (plugins) {
            ...
            __spread([default_1.default], plugins).forEach(function (plugin) {
        ...
        this.findLayoutPlugin = function (name, version) {
            ...
            return {
                plugin: plugin || new classes_1.LayoutPlugin(missing_1.layoutMissing({ name: name, version: version })),
        ...
        this.findContentPlugin = function (name, version) {
            ...
            return {
                plugin: plugin || new classes_1.ContentPlugin(missing_1.contentMissing({ name: name, version: version })),
                pluginWrongVersion: pluginWrongVersion,
            };
        };
        /**
        ...
        this.plugins = {
            content: __spread([default_1.default], content).map(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
